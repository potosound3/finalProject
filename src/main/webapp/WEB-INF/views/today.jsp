...
<body>
	<section class="ftco-section">
		<div class="container m-10">
			<div class=".justify-content-start" style="float:left;">
				<img src="/finalProject/resources/images/food1.jpg" width="400" height="400">
			</div>
			<div class="row text-">
	...
	<div class="text-center">
		<img src="/finalProject/resources/images/arrow2.png" onclick="menu()" width="100" height="100" style="margin-bottom: 50px;">
	</div>
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<div class="row mt-4">
						...
						<form name="cartForm" method="post"
								action="/finalProject/order/cart/insert">
						...
						<div class="w-100"></div>
						<a href="/finalProject/product" class="btn btn-primary py-3 px-5">상품목록보기</a>&nbsp;&nbsp;
						<a href="/finalProject/order/order" class="btn btn-primary py-3 px-5">주문하기</a>
						<!-- <div class="col-md-12">
