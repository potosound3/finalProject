...
.weatherBox {
	...
	width: 100%;
	height: 50%;
	background-image: url("/finalProject/resources/images/weather.jpg");
	...
	<div class="container">
		...
		<c:forEach var="row" items="${list}">
			<div class="col-md-6 col-lg-3 ftco-animate">
				<div class="product">
					<a href="/finalProject/product/${row.productNo}" class="img-prod"><img
						class="img-fluid"
					...
					<div class="text py-3 pb-4 px-3 text-center">
						...
						<div class="bottom-area d-flex px-3">
							<div class="m-auto d-flex">
								...
								<!-- 찜하기 -->
								<a href="/finalProject/mypage/wishlistAdd/${row.productNo}"
