									...
									<table class="table">
										...
										<tbody>
														...
														<div id="id01" class="w3-modal w3-animate-opacity">
															<div class="w3-modal-content w3-card-4">
																...
																<div class="w3-container">
																	...
																	<h3><a href="/finalProject/order/cart/delete?cartNo=${row.cartNo}">
																	<span>Yes</span></a></h3>
																</div>
															</div>
														</div>
											...
											<tr class="text-center">
												...
												<td><a href="/finalProject/product" class="btn btn-primary py-3 px-5">상품목록보기</a></td>	
												<td><a href="/finalProject/order/order" class="btn btn-primary py-3 px-5">주문하기</a></td>	
											</tr>
											<!-- END TR-->
										</tbody>
									</table>
									<form name="headerForm" method="post" action="/finalProject">
