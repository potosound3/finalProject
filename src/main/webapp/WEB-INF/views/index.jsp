		...
		<div id="carousel-example-generic" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="/finalProject/resources/mart/images/best1.png" width="1648" height="600"
						alt="">
					<div class="carousel-caption"></div>
				</div>
				<div class="item">
					<img src="/finalProject/resources/mart/images/best.png" width="1648" height="600"
						alt="">
					<div class="carousel-caption"></div>
				</div>
				<div class="item ">
					<img src="/finalProject/resources/mart/images/best02.png" width="1648" height="600"
						alt="">
					<div class="carousel-caption"></div>
				</div>
			</div>
...
<!-- 	
	...
	<section class="ftco-section img" style="background-image: url((/finalProject/resources/mart/css/images/timeback.jpg);">
       <div class="container">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-4 wow fadeInDown animated" data-wow-delay="0.2s">
					<div class="blog-item">
						<img src="/finalProject/resources/images/a11.jpg" width="350"
							height="262" alt="">
					</div>
				</div>
				<div class="col-sm-4 wow fadeInDown animated" data-wow-delay="0.4s">
					<div class="blog-item">
						<img src="/finalProject/resources/images/a21.jpg" width="350"
							height="262" alt="">
				...
				<div class="col-sm-4 wow fadeInDown animated" data-wow-delay="0.6s">
					<div class="blog-item">
						<img src="/finalProject/resources/images/a31.jpg" width="350"
							height="262" alt="">
