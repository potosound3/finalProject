		...
		<div class="member_cont">
			<form id="formLogin" method="post" action="login" class="loginForm">
				...
				<div class="member_sns_login">
					<a href="https://kauth.kakao.com/oauth/authorize?client_id=0e5da3292d8e58d5694244ef5bc3539e&redirect_uri=http://localhost:8089/finalProject/member/kakaologinCallback&response_type=code"> <img width="471" src="/finalProject/resources/images/kakao_login_btn.png" class="btn_social"/></a>
					<a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=38SdDQt0VXvmWJ3wviN6&redirect_url=http://localhost:8089/finalProject/member/naverCallback&state=8297"> <img width="471" src="/finalProject/resources/images/naver_login_btn.png" class="btn_social"/></a>
				</div>
